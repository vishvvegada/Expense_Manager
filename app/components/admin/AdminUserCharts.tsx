...
export default function AdminUserCharts({ monthlyData, categoryData, incomeCategoryData }: AdminUserChartsProps) {
    return (
        <div className="space-y-8">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
                {/* Monthly Overview */}
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 xl:col-span-2">
                    <h3 className="text-lg font-semibold text-gray-800 mb-6">Monthly Financial Overview</h3>
                    <div className="h-80">
